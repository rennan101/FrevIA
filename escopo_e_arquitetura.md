...
| **AWS Lambda**                                | Processamento de regras de negócios, webhooks e APIs privilegiadas sem servidor (Runtime: **Node.js 22.x LTS**).        | AWS Edge Functions     | **R$ 0,00** *(Incluso no milhão de requisições gratuitas/mês)*           |
