...
const ASSETS_TO_CACHE = [
  ...
  './js/modules/score-engine.js',
  './js/modules/audio-player.js',
  './js/modules/modals/alert-modal.js',
  ...
  './js/modules/views/steps.js',
  './js/modules/views/history.js',
  './js/modules/views/map.js',
  './js/modules/views/admin.js',
  './js/app.js',
  './manifest.json',
